...
import { sigupValidationSchema } from "../formik/yup/YupValidationSchema";
      ...
      >
        {({ handleChange, handleBlur, values, touched, errors, isValid }) => (
          <Form className="min-w-[300px] md:w-[400px] shadow-lg rounded-md shadow-gray-300 p-5">
            <h1 className="head-1 text-center py-2">SIGN UP</h1>
            <div className="mt-5 flex flex-col">
              ...
              <button
                className={
                  "w-[80%] mt-4 mx-auto bg-black py-2 rounded-md text-white hover:bg-gray-800 " +
